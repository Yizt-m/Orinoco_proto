...
<head>
    ...
    <title>Reporte AT48 - Orinoco Proto</title>
...
<body class="main-app">
    ...
    <main class="main-content" id="main-content">
        <div class="content-wrapper">
            <h1>Generador de Reporte AT48</h1>
            <p>Por favor, cargue los archivos correspondientes para generar el reporte.</p>
            
            <form action="php/procesar_at48.php" method="POST" enctype="multipart/form-data" style="margin-top: 2rem;">
                
                <div class="form-group">
                    <label for="archivo_at48">
                        <strong>Archivo AT48 (Formato: .txt)</strong>
                    </label>
                    <input type="file" id="archivo_at48" name="archivo_at48" class="input-field" required accept=".txt">
                </div>
