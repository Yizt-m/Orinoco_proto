...
<head>
    ...
    <title>Reporte de Reembolsos - Orinoco Proto</title>
...
<body class="main-app">
    ...
    <main class="main-content" id="main-content">
        <div class="content-wrapper">
            <h1>Generador de Reporte de Reembolsos</h1>
            <p>Por favor, cargue los archivos correspondientes para generar el reporte.</p>
            
            <form action="php/procesar_reembolsos.php" method="POST" enctype="multipart/form-data" style="margin-top: 2rem;">
