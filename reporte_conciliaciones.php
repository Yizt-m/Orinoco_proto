...
<head>
    ...
    <title>Reporte Conciliaciones - Orinoco Proto</title>
...
<body class="main-app">
    ...
    <main class="main-content" id="main-content">
        <div class="content-wrapper">
            <h1>Generador de Reporte de Conciliaciones</h1>
            <p>Por favor, cargue los archivos correspondientes para generar el reporte.</p>
            
            <form action="php/procesar_conciliaciones.php" method="POST" enctype="multipart/form-data" style="margin-top: 2rem;">
                
                <div class="form-group">
                    <label for="archivo_s01">
                        <strong>Archivo Red de Agente (S01) (Formato: .txt)</strong>
                    </label>
                    <input type="file" id="archivo_s01" name="archivo_s01" class="input-field" required accept=".txt">
                </div>
